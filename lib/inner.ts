...
const Sbox = new Array(99, 124, 119, 123, 242, 107, 111, 197, 48, 1, 103, 43, 254, 215, 171,
...
export function crypt(encrypt:boolean, Text:string, Key:string, IV:string) {
...
class AesCtr {
  ...
  encrypt(plaintext: string, IV:string) {
    return crypt(true,plaintext,this.pass,IV);
  }

   decrypt(ciphertext: string,IV:string) {
